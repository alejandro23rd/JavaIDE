...
<main>
	...
	<form action="#" method="post">
		...
		<br> <label for="deportes">Deportes</label> <br> <input
			type="checkbox" name="deportes" id="deportes" value="1">Surf
		<br> <input type="checkbox" checked name="deportes" id="deportes"
			value="2">Quidditch <br> <input type="checkbox"
			name="deportes" id="deportes" value="3">Jugger <br> <input
			type="checkbox" name="deportes" id="deportes" value="4">Petanca
		<br> <br> <label for="situacion">Situación Actual</label> <br>
		<input type="radio" checked name="situacion" id="situacion" value="0">Trabajando
		<br> <input type="radio" name="situacion" id="situacion"
			value="1">Desempleado <br> <br> <label
			for="observaciones">Observaciones</label> <br>
